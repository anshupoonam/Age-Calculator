...
import 'package:agecalc2/model/model.dart';
...
class AgeCalculator {
 ...
 static String findDayName() {
    ...
    var sp = selectedBirthDate.toString().split(' ')[0].split("-");
  ...
  static String findDayNamewithDate(DateTime inputDate) {
    if (inputDate.isBefore(selectedCurrentDate)) {
